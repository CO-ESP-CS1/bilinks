...
type PhoneInputProps = {
  ...
  provider?: "MTN" | "AIRTEL";
  /** Couleur d'accent du focus — "violet" (tunnel Particulier, défaut) ou "blue" (tunnel Établissement, #004AC6). */
  accent?: "violet" | "blue";
};

export function PhoneInput({ value, onChange, provider, accent = "violet" }: PhoneInputProps) {
  ...
  return (
    <div
      className={cn(
        "flex h-[52px] overflow-hidden rounded-xl border-[1.5px] border-zinc-200",
        accent === "blue"
          ? "focus-within:border-[#004AC6] focus-within:shadow-[0_0_0_3px_rgba(0,74,198,0.10)]"
          : "focus-within:border-violet-500 focus-within:shadow-[0_0_0_3px_rgba(124,58,237,0.10)]"
      )}
    >
